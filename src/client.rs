...
impl ClobClient {
    ...
    pub async fn derive_api_key(&self, nonce: Option<u64>) -> ClobResult<ApiKeyCreds> {
        ...
        let response: ApiKeyRaw = self.http_client.get(&endpoint, Some(headers), None).await?;
    ...
    pub async fn delete_api_key(&self) -> ClobResult<serde_json::Value> {
        ...
        let endpoint = format!("{}{}", self.host, endpoint_path);
        self.http_client
            .delete(&endpoint, Some(headers), None::<()>, None)
            .await
    }
    ...
    pub async fn post_order(
        ...
        let endpoint = format!("{}{}", self.host, endpoint_path);
        self.http_client
            .post(&endpoint, Some(final_headers), Some(order_payload), None)
            .await
    }
    ...
    pub async fn post_orders(&self, orders: Vec<PostOrdersArgs>) -> ClobResult<serde_json::Value> {
        ...
        let endpoint = format!("{}{}", self.host, endpoint_path);
        self.http_client
            .post(&endpoint, Some(final_headers), Some(payloads), None)
            .await
    }
    ...
    pub async fn cancel_order(&self, order_id: &str) -> ClobResult<serde_json::Value> {
        ...
        let endpoint = format!("{}{}", self.host, endpoint_path);
        self.http_client
            .delete(&endpoint, Some(headers), Some(payload), None)
            .await
    }
    ...
    pub async fn cancel_market_orders(
        ...
        let endpoint = format!("{}{}", self.host, endpoint_path);
        self.http_client
            .delete(&endpoint, Some(headers), Some(params), None)
            .await
    }
